...
import ch.lianto.openai.client.model.CreateImageRequestModel;
...
public class CreateImageRequest {
  ...
  private JsonNullable<CreateImageRequestModel> model = JsonNullable.<CreateImageRequestModel>of(dall-e-2);
