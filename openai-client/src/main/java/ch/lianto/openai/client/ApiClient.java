...
import ch.lianto.openai.client.auth.Authentication;
import ch.lianto.openai.client.auth.HttpBasicAuth;
import ch.lianto.openai.client.auth.HttpBearerAuth;
import ch.lianto.openai.client.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    protected void init() {
        ...
        authentications.put("ApiKeyAuth", new HttpBearerAuth("bearer"));
