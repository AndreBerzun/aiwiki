...
import ch.lianto.aiwiki.cli.service.PageChunkFormat;
...
public class UtilCommands {
    ...
    public void convertToVespaFeed(
        ...
        @Option(defaultValue = "chunksOnly") PageChunkFormat format
        ) {
        if (StringUtils.isNotBlank(inputDirectoryPath) && StringUtils.isNotBlank(projectName))
            ...
            conversionService.convertProjectToVespaFeed(projectName, outputPath, format);
        else
